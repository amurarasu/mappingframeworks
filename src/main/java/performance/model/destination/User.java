...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass() == performance.model.source.User.class) {
            performance.model.source.User user =
              (performance.model.source.User) o;
    ...
    public AccountStatus conversion(performance.model.source.AccountStatus status) {
